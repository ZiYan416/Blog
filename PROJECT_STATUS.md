...
### ✅ 移动端适配与视觉体验升级
- [x] 移动端侧滑菜单 (Sheet) 集成
- [x] 全局字体优化 (Noto Serif SC 衬线体集成)
- [x] 开屏动画 (Splash Screen)
- [x] 页面骨架屏 (Skeleton) 全覆盖 (首页/文章/关于/标签)
- [x] Logo 与 Slogan 视觉微调 (Times New Roman / Font Weight)
- [x] 认证流程体验优化 (头像自动清理、登录问候语)

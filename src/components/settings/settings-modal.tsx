...
export function SettingsModal({ open, onOpenChange }: SettingsModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-white/95 dark:bg-neutral-900/95 backdrop-blur-xl border border-black/10 dark:border-white/10 rounded-3xl p-6 shadow-2xl">
        <DialogHeader className="pb-4 border-b border-black/5 dark:border-white/5">
          <DialogTitle className="flex items-center gap-2.5 text-xl font-bold tracking-tight">
            <div className="w-9 h-9 rounded-2xl bg-black/5 dark:bg-white/5 flex items-center justify-center text-black dark:text-white">
        ...
        <div className="py-4 space-y-4">
          <div className="flex items-start justify-between p-4 rounded-2xl bg-neutral-50 dark:bg-neutral-800/60 border border-black/5 dark:border-white/5 transition-all">
